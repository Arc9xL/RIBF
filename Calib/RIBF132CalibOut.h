...
public :
  ...
  Double_t PPAC_Tx1[7][4];
  Double_t PPAC_Tx2[7][4];
  Double_t PPAC_Ty1[7][4];
  Double_t PPAC_Ty2[7][4];
...
void RIBF132CalibOut::Init()
{
  ...
  // Added by Divyang to plot Tx1-Tx2 and Ty1-Ty2 correlation
  fChain -> Branch("PPAC_Tx1", PPAC_Tx1, "PPAC_Tx1[7][4]/D");
  fChain -> Branch("PPAC_Tx2", PPAC_Tx2, "PPAC_Tx2[7][4]/D");
  fChain -> Branch("PPAC_Ty1", PPAC_Ty1, "PPAC_Ty1[7][4]/D");
  fChain -> Branch("PPAC_Ty2", PPAC_Ty2, "PPAC_Ty2[7][4]/D");
