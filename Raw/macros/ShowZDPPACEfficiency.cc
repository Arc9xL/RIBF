...
void ShowZDPPACEfficiency::Construct() {
  ...
  h_zd_zed_dummy  = new TH2F("ZedDummy","ZedDummy",14,0,14,100,20,40);
  h_zd_zed_ppac_x = new TH2F("ZedGateX","ZedGateX",14,0,14,100,20,40); 
  h_zd_zed_ppac_y = new TH2F("ZedGatey","ZedGateY",14,0,14,100,20,40); 

  h_zd_ppac_eff_x = new TH2F("PPACEffX","PPACEffX",14,0,14,100,20,40); 
  h_zd_ppac_eff_y = new TH2F("PPACEffY","PPACEffY",14,0,14,100,20,40); 
