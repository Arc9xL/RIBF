...
protected:
  ...
  Double_t F11VetoPLA_TL_raw;
  Double_t F11VetoPLA_TR_raw;
  Double_t F11VetoPLA_TL;
  Double_t F11VetoPLA_TR;
  Double_t F11VetoPLA_T;

  Int_t F11VetoPLA_QL_raw;   
  Int_t F11VetoPLA_QR_raw; 
  Int_t F11VetoPLA_Q_ave;

  Double_t F11longPLA_TL_raw;
  Double_t F11longPLA_TR_raw;
  Double_t F11longPLA_TL;
  Double_t F11longPLA_TR;
  Double_t F11longPLA_T;

  Int_t F11longPLA_QL_raw;   
  Int_t F11longPLA_QR_raw; 
  Int_t F11longPLA_Q_ave;
  ...
  Int_t F11ICRawADC[8];
  Int_t F11ICRawTDC[8];//F11TDC                                                                                         
  Int_t F11ICT[8];
  Int_t F11ICNumHit;
  Double_t F11ICEnergySqSum;
  Double_t F11ICEnergyAvSum;

  Int_t F11ICRawADC2[8];
  Int_t F11ICRawTDC2[8];//F11 TDC                                                                                       
  Int_t F11ICT2[8];
  Int_t F11ICNumHit2;
  Double_t F11ICEnergySqSum2;
  Double_t F11ICEnergyAvSum2;

  Int_t F11TDCref;//F11TDC                                                                                              
  Int_t F11PLA_TR_F11T;//F11TDC
  Int_t F11PLA_TL_F11T;//F11TDC
  // Int_t F11PLA_TUR_F11T;//F11TDC                                                                                        
  //  Int_t F11PLA_TUL_F11T;//F11TDC                                                                                        
  //  Int_t F11PLA_TDR_F11T;//F11TDC                                                                                        
  //  Int_t F11PLA_TDL_F11T;//F11TDC                                                                                        
  Int_t F11VetoPLA_TL_F11T;//F11TDC                                                                                     
  Int_t F11VetoPLA_TR_F11T;//F11TDC                                                                                     
  Int_t F11longPLA_TL_F11T;//F11TDC                                                                                     
  Int_t F11longPLA_TR_F11T;//F11TDC    
