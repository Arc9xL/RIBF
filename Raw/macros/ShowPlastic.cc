...
void ShowPlastic::Construct() {
  ...
  h_time_l_raw = new TH2F("TimeLeftRaw","Time Left Raw",8,0,8,4000,0,100000);
  h_time_r_raw = new TH2F("TimeRightRaw","Time Right Raw",8,0,8,4000,0,100000);

  h_time_l = new TH2F("TimeLeft","Time Left",8,0,8,8000,0,8000);
  h_time_r = new TH2F("TimeRight","Time Right",8,0,8,8000,0,8000);

  h_time = new TH2F("Time","Time",8,0,8,8000,0,8000);

  h_ql_raw = new TH2F("QLRaw","Q Left Raw",8,0,8,8000,0,8000);
  h_qr_raw = new TH2F("QRRaw","Q Right Raw",8,0,8,8000,0,8000);

  h_q_ave_raw = new TH2F("Q Ave Raw","Q Ave Raw",8,0,8,8000,0,8000);
...
void ShowPlastic::Calculate()  {
  ...
  char *name_plastic[8]={"F3pl","F5pl","F7pl","F8pl","F11pl-1","F11pl-2","F11long","F11veto"};
